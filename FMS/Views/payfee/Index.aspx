...
<script type="text/javascript">
    $(function () {
        lastpayfeeid = '<%:TempData["lastid"]%>';
        print = '<%:TempData["print"]%>';
        if (lastpayfeeid != '' && print=="true") {
            ajaxLoadToPdf("fakeParameter", "/payfee/PrintToPDF/" + lastpayfeeid);
        }
    });
</script>
...
<p class="moduleTitle">List of  Payments</p>
...
<div class="commonActions">
    ...
    <%: Html.MyActionLink("Bulk Pay Fee", "payfee", "bulkPayFee",null, "ajaxLoad", "mainContentPlaceHolder", "class='ui-button' id='payfeebulkPayFee'")%>    
     ...
     <fieldset>
            <legend class="ui-widget-header ui-corner-top">Filter Payments</legend>
            <div id="filterpayfee" class="padding1px">
                <div class="formFieldDiv">
                    <div class="editor-label ui-state-default">Department</div>
                    <div class="editor-field"><input type="text" id="inputDept" name="Dept" value="" onchange="reloadGrid('payfee')"/></div>
                    
                </div>
                 <div class="formFieldDiv">
                    <div class="editor-label ui-state-default">Semester</div>
                    <div class="editor-field"><input type="text" id="inputSem" name="Sem" value="" onchange="reloadGrid('payfee')"/></div>
               </div>
                
                <div class="formFieldDiv">
                    <div class="editor-label ui-state-default">Name</div>
                    <div class="editor-field"><input type="text" id="inputName" name="Name" value="" onchange="reloadGrid('payfee')"/></div>
                </div>  
                <div class="formFieldDiv">
                    <div class="editor-label ui-state-default">Hall Ticket No</div>
                    <div class="editor-field"><input type="text" id="inputHTNo" name="HTNo" value="" onchange="reloadGrid('payfee')"/></div>
                </div> 
                ...
                <div class="formFieldDiv">
                    ...
                    <div class="editor-field"><%: Html.DropDownList("quotaid", null, new { @class = "chzn-select", multiple = "", style = "width:206px;", onchange = "reloadGrid('payfee')" })%></div>
                </div> 
                <%-- <div class="formFieldDiv">
                ...
                <div class="formFieldDiv">
                    ...
                    <div class="editor-field"><%: Html.DropDownList("batchid", null,new { @class = "chzn-select", multiple = "", style = "width:206px;", onchange = "reloadGrid('payfee')" })%></div>
                    
                </div>
                <div class="formFieldDiv">
                    <div class="editor-label ui-state-default">Fee Type</div>
                    <div class="editor-field"><%: Html.DropDownList("feetypeid", null,new { @class = "chzn-select", multiple = "", style = "width:206px;", onchange = "reloadGrid('payfee')" })%></div>
                </div>
                <div class="formFieldDiv">
                    <div class="editor-label ui-state-default">Academic Year</div>
                    <div class="editor-field"><%: Html.DropDownList("acayearid", null,new { @class = "chzn-select", multiple = "", style = "width:206px;", onchange = "reloadGrid('payfee')" })%></div>
                </div>
               <div class="formFieldDiv">
            ...
            <input type="button" class="ui-button" onclick="clearChoicesDiv('filterpayfee');resetFormReloadGrid('payfee');" value="Reset" />
             <input type="button" class="ui-button" onclick="reloadGrid('payfee')" value="Reload" />
     </fieldset>
     
     
    <div id="payfeeGridContainer" style="position: relative">
            <div class="actionContent hideDiv" id="payfeeActions">
                <div id="needToAddId" class="floatLeft">
                    <%: Html.MyActionLink("", "payfee", "Edit", new{id=1}, "ajaxLoad", "mainContentPlaceHolder", "class='ui-icon ui-icon-pencil floatLeft' id='payfeeEdit'")%>
                    <%: Html.MyActionLink("", "payfee", "Delete", new { id =1}, "ajaxLoad", "mainContentPlaceHolder", "class='ui-icon ui-icon-trash floatLeft' id='payfeeDelete'")%>
                    <%: Html.MyActionLink("", "payfee", "PrintToPDF", new { id = 1 }, "ajaxLoadToPdf", "mainContentPlaceHolder", "class='ui-icon ui-icon-print floatLeft' id='payfeePrint'")%>
                    <%: Html.MyActionLink("", "payfee", "Details", new { id =1}, "ajaxLoad", "mainContentPlaceHolder", "class='ui-icon ui-icon-details floatLeft' id='payfeeDetails'")%>
                </div>
                <span class="ui-icon ui-icon-close floatLeft curPointer" onclick="hide('payfeeActions');">
                </span>
            </div>
...
//                Caste   : function () { return $("#inputCaste").val(); },
            ...
            colNames: ['id','Student Id', 'HTNo', 'Name','Semester','Batch','Quota',/*'Caste',*/'Academic Year', 'Fee Type','Amount','Time','Receipt No'],
            colModel: [
...
//                        { name: 'Caste', index: 'Caste'},
                        ...
                        { name: 'receiptNo', index: 'receiptNo', align:'left'}],
            rowNum: 10, 
        ...
        $("#"+contextName).navButtonAdd('#page'+contextName, {
                ...
                onClickButton: function () {
                    var myUrl = "/payfee/exportGridToExcel?h=h";
        ...
        if ("True"=="<%:Html.checkActionPermission("payfee","Create")%>") {
            $("#"+contextName).navButtonAdd('#page'+contextName, {
                caption: "",
                buttonicon: "ui-icon-plus",
                onClickButton: function () {
                    ajaxLoad('mainContentPlaceHolder', '/payfee/Create');
                },
                position: "first",
